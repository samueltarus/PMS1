...
<div class="content">
    <div class="row">
        ...
        <a href="{{url('add-invoice')}}" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Create New Invoice</a>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <div class="dropdown dropdown-action">
                                    ...
                                    <a class="dropdown-item" href="{{url('view-invoice')}}"><i class="fa fa-eye m-r-5"></i> View</a>
